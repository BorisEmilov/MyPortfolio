...
const Nav = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 text-white w-[100%] h-[35px] flex flex-row items-center justify-around md:justify-start md:gap-10 text-[14px] md:text-[16px] bg-gradient-to-r from-[#468faf] to-[#014f86] z-20`}>
            ...
            <div onClick={() => scrollToSection('constact')} className='flex items-center justify-center p-1 cursor-pointer'>
                <p><b>Contact</b></p>
            </div>
        </div>
    )
