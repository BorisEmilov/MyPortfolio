...
const Nav = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 text-[#edae49] w-[100%] h-[35px] flex flex-row items-center justify-around md:justify-start md:gap-10 text-[14px] md:text-[16px] bg-gradient-to-r from-[#468faf] to-[#014f86] border-b-solid border-b-[1px] border-b-[#014f86] z-20`}>
